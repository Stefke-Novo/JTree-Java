...
public class FrmPrimer extends javax.swing.JFrame {
    ...
    private void jTree1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTree1MouseClicked
        ...
        jTextFieldSelectedNode.setText(nazivFajla);
    ...
    private void jButtonCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreateActionPerformed
        ...
        try {
            ...
            model.createFile(parent, jTextFieldNewNode.getText(),jComboBox1.getSelectedItem().toString());
            jTree1.updateUI();
        }
        catch (IOException ex) {
    ...
    private void jButtonRenameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRenameActionPerformed
        ...
        File novi = new File(selection.getParentFile().getPath()+File.separator+new File(jTextFieldSelectedNode.getText()));
        jTree1.updateUI();
